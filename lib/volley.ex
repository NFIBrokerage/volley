defmodule Volley do
  ...
  Volley provides a GenStage producer `Volley.LinearSubscription` and a
  ...
  The `Volley.LinearSubscription` producer is a simpler subscription
  ...
  Linear subscriptions have less resource impact on the EventStoreDB but are
  less flexible than persistent subscriptions. Linear subscriptions are subject
